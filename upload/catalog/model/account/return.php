...
class ModelAccountReturn extends Model {
	...
	public function getTotalReturns() {
		$query = $this->db->query("SELECT COUNT(*) AS total FROM {return}WHERE customer_id = '" . $this->customer->getId() . "'");
